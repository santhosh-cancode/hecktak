    ...
    <footer className="footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <p className="footer-description">
            Empowering businesses with custom software solutions, high-performance static/dynamic websites, billing software, and result-oriented digital marketing strategies.
          </p>
        ...
        <div className="footer-links">
          ...
          <ul>
            ...
            <li><a href="#services" onClick={(e) => handleLinkClick(e, 'services')}>About Us</a></li>
        ...
        <div className="footer-contact">
          <h3>Contact Info</h3>
          <p>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ marginRight: '10px', verticalAlign: 'middle' }}>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-content">
          <p>&copy; {currentYear} HECKTAK. All Rights Reserved.</p>
          <p>Designed and Built for Digital Growth</p>
        </div>
      </div>
    </footer>
  );
